...
1. "polished": Authentic De-Cluttered Script. Preserve 100% of the user's exact personal voice, vocabulary, stories, and tone. Remove filler words ("um", "uh", "like", "you know", "basically"), false starts, and stuttered restarts.

2. "masterScript": Ideal Master Speech Script ON THIS EXACT TOPIC.
   - Write a REAL, HIGH-IMPACT, TOPIC-SPECIFIC SPOKEN SPEECH SCRIPT.
   - Format with markdown headers: **📌 Opening Hook & Thesis**, **💡 Core Argument 1**, **🎯 Real-World Evidence**, **🏁 High-Impact Closing**.

3. "coachingTips": Array of 3-4 specific, actionable coaching points.

4. "structuralMapping": Object with keys point, reason, example, conclusion.

5. "strongestPoint": The single most compelling sentence from their original speech.

Return ONLY a raw JSON object with keys: polished, masterScript, coachingTips, structuralMapping, strongestPoint.`;
    ...
    console.error('Vercel API polish error:', err);
